import { Container, Field, Form, Props, Screen } from "../../../model/Canvas/Screen";
...
export function importJSONFiles(files: any[],fileProperty: string) {
    ...
    for (let index = 0; index < files.length; index++) {
        ...
        for (let i = 0; i < children.length; i++) {
            ...
            if(fieldType == "formViewer" || fieldType == "form") {
        ...
        const scrn = new Screen(screenName,width,height,screenFill,fields,forms,containers);
