import { formatDate, isDate, isNumber, showFliconIcon } from "../../../util/utils";
import {hexToRGBA, hexToRgb} from '../../../util/colorUtil';
import { Row } from "../../../model/ModelDriven/Grid";

export function addNavigationContent(frame: FrameNode | ComponentNode, background: { r: number; g: number; b: number; } | null, textColor: { r: number; g: number; b: number; } | null, topColor: { r: number; g: number; b: number; } | null,
    name: string) {
    const searchColor = hexToRgb("#D3C0D4");
    
    const navigation = figma.createFrame();
    navigation.name = "Navigation";
    navigation.resize(1696,48);
    ...
    showFliconIcon("Waffle","Waffle",0,0,20,20,hexToRGBA("#FFFFFF",1),left,true);
    ...
    showFliconIcon("Search","Search",0,0,20,20,hexToRGBA("#000000",1),search,true);
    ...
    showFliconIcon("Search","Search",0,0,20,20,hexToRGBA("#FFFFFF",1),right,true);
    showFliconIcon("Add","Add",0,0,20,20,hexToRGBA("#FFFFFF",1),right,true);
    showFliconIcon("Filter","Filter",0,0,20,20,hexToRGBA("#FFFFFF",1),right,true);
    showFliconIcon("Settings","Settings",0,0,20,20,hexToRGBA("#FFFFFF",1),right,true);
    showFliconIcon("QuestionMark","QuestionMark",0,0,20,20,hexToRGBA("#FFFFFF",1),right,true);
    showFliconIcon("User","User",0,0,20,20,hexToRGBA("#FFFFFF",1),right,true);
...
export function addSiteMap(pageContent: FrameNode | ComponentNode, background: { r: number; g: number; b: number; } | null, textColor: { r: number; g: number; b: number; } | null, menucolor: { r: number; g: number; b: number; } | null) {
    ...
    showFliconIcon("Hamburger","Hamburger",0,0,20,20,hexToRGBA("#000000",1),hamburger,true);
    ...
    const item2 = addMenuItem(menucolor,textColor,"Recent","Recent",true,false,true);
    ...
    const groupItem2 = addMenuItem(menucolor,textColor,"Recent","Label",false,false,true);
...
export function addArea(menucolor: { r: number; g: number; b: number; } | null, strokeColor: { r: number; g: number; b: number; } | null, primaryColor: { r: number; g: number; b: number; } | null, background: { r: number; g: number; b: number; } | null, textColor: { r: number; g: number; b: number; } | null) {
    ...
    showFliconIcon("UpDown","UpDown", 0, 0, 20, 20, hexToRGBA("#000000", 1), area, true);
    return area;
}
...
export function addMenuItem(menucolor: { r: number; g: number; b: number; } | null, textColor: { r: number; g: number; b: number; } | null,iconName: string,name: string,showSub: boolean,selectedItem: boolean,showVisibility:boolean) {
    ...
    item.paddingTop = 9;
    item.paddingBottom = 9;
    item.visible = showVisibility;

    showFliconIcon(iconName,iconName,0,0,16,16,hexToRGBA("#000000",1),item,true);
    ...
    if(showSub) {
        showFliconIcon("Down","Down",0,0,14,14,hexToRGBA("#000000",1),item,true);
    }

    return item;
}

export function addMainContent(pageContent: FrameNode | ComponentNode, background: { r: number; g: number; b: number; } | null, textColor: { r: number; g: number; b: number; } | null) {
    const strokeColor = hexToRgb("#DCDBDB");
    ...
    showFliconIcon("MoreVertical","More", 0, 0, 20, 20, hexToRGBA("#000000", 1), bar,true);    
...
export function addHeader(mainContent: FrameNode,background: { r: number; g: number; b: number; } | null, textColor: { r: number; g: number; b: number; } | null, darkText: { r: number; g: number; b: number; } | null,headerName: string) {
    ...
    showFliconIcon("Down","Down", 0, 0, 20, 20, hexToRGBA("#000000", 1), headerFrame, true);
    ...
    showFliconIcon("Search","Search", 0, 0, 20, 20, hexToRGBA("#595959", 1), searchFrame, true);
...
export function addHeaderForm(mainContent: FrameNode, background: { r: number; g: number; b: number; } | null, textColor: { r: number; g: number; b: number; } | null, headerName: string, headerFormName: string | undefined) {
    ...
    tabText.characters = headerFormName != undefined ? headerFormName :"General";
    tabText.name = "label";
    tabText.fontSize = 14;
...
export function addItem(bar: FrameNode, textColor: { r: number; g: number; b: number; } | null,iconName: string,value: string,hex: string) {
    showFliconIcon(iconName,iconName, 0, 0, 20, 20, hexToRGBA(hex, 1), bar,true);
...
export function addIconRows(tableFrame: FrameNode, count: number, background: { r: number; g: number; b: number; } | null, strokeColor: { r: number; g: number; b: number; } | null, hex: string, iconName: string) {
    ...
    for (let index = 0; index < count; index++) {
        ...
        if(index == 0) showFliconIcon(iconName,iconName, 0, 0, 20, 20, hexToRGBA(hex, 1), cellFrame,true);
        else showFliconIcon(iconName,iconName, 0, 0, 20, 20, hexToRGBA(hex, 1), cellFrame,false);
...
export function addTextRows(contentFrame: FrameNode, count: number, background: { r: number; g: number; b: number; } | null,textColor: { r: number; g: number; b: number; } | null, strokeColor: { r: number; g: number; b: number; } | null, value: string,textHex: string,headerName: string,horizontal: LayoutMixin["layoutSizingHorizontal"]) {
    ...
    showFliconIcon("SortUp","SortUp", 0, 0, 16, 16, hexToRGBA("#000000", 1), headerFrame,true);
    showFliconIcon("Down","Down", 0, 0, 16, 16, hexToRGBA("#000000", 1), headerFrame,true);
    showFliconIcon("SortDown","SortDown", 0, 0, 16, 16, hexToRGBA("#000000", 1), headerFrame,true);
    showFliconIcon("Filter","Filter", 0, 0, 16, 16, hexToRGBA("#000000", 1), headerFrame,true);
